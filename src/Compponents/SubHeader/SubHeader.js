                ...
                <div className="sub-header-content">
                    <div className="sub-header-txt">
                        ...
                        <ul className='sub-header-list'>
                            <li><i class='bx bx-check-double'></i><span>۱۰ سال تجربه ارایه خدمات تخصصی دیجیتال مارکتینگ و راهکارهای نوین بازاریابی</span></li>
                            <li><i class='bx bx-check-double'></i><span>تمرکز ما در تمامی استراتژی های اجرایی معطوف به دیجیتال برندینگ و همسو کردن استراتژی های دیجیتال مارکتینگ با دیگر فعالیت های برندینگ و بازاریابی شما می باشد.</span></li>
                            <li><i class='bx bx-check-double'></i><span>برای دریافت آخرین اخبار، گرایش ها و رویداد های دیجیتال مارکتینگ ثبت نام کنید</span></li>
                        </ul>
                    </div>
                    <div className="sub-header-img"><img src="img/about.jpg" alt="" /></div>
                </div>
                <div className="client-logo-section">
                    <div className="client-logo-container">
                        <div className="client-logo"><img src="img/logos/client-1.png" alt="" /></div>
                        <div className="client-logo"><img src="img/logos/client-2.png" alt="" /></div>
                        <div className="client-logo"><img src="img/logos/client-3.png" alt="" /></div>
                        <div className="client-logo"><img src="img/logos/client-4.png" alt="" /></div>
                        <div className="client-logo"><img src="img/logos/client-5.png" alt="" /></div>
                        <div className="client-logo"><img src="img/logos/client-6.png" alt="" /></div>
                    </div>
                </div>
            </div>
